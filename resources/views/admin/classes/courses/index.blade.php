        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">@lang('classes.courses')</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.courses.index')}}" class="text-muted">@lang('classes.courses')</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom gutter-b" style="width: 100%;">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">@lang('classes.courses')</h3>
                    </div>
                    ...
                    <span class="svg-icon svg-icon-md">
                        ...
                        <!--end::Svg Icon-->
                    </span>@lang('classes.new-course')</a>
                        <!--end::Button-->
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-checkable " id="kt_datatable">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th>@lang('classes.image')</th>
                                        <th>@lang('classes.category')</th>
                                        <th>@lang('classes.name')</th>
                                        <th>@lang('classes.hours')</th>
                                        <th>@lang('classes.calories')</th>
                                        <th>@lang('classes.workout_intensity')</th>
                                        <th>@lang('classes.day')</th>
                                        <th>@lang('classes.time_start')</th>
                                        <th>@lang('classes.time_end')</th>
                                    ...
                                    @if(count($courses)>0)
                                        ...
                                        @foreach($courses as $course)
                                            <tr>
                                                <td>{{$course->id}}</td>
                                                <td><img src="{{asset_public('storage/images/'.$course->image()->pluck('image')[0])}}" style="width: 70px ; height: 60px;"></td>
                                               @if(app()->getLocale() == 'en')
                                                    <td>{{$course->category()->pluck('name_en')[0]}}</td>
                                                    <td>{{$course->name_en}}</td>
                                               @else
                                                    <td>{{$course->category()->pluck('name_ar')[0]}}</td>
                                                    <td>{{$course->name_en}}</td>
                                                @endif
                                                <td>{{$course->hours}}</td>
