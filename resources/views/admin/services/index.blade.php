        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">@lang('services.services')</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.services.index')}}" class="text-muted">@lang('services.services')</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom gutter-b" style="width: 100%;">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">@lang('services.services')</h3>
                    </div>
                    ...
                    <span class="svg-icon svg-icon-md">
                        ...
                        <!--end::Svg Icon-->
                    </span>@lang('services.new-service')</a>
                        <!--end::Button-->
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <table class="table table-bordered table-checkable " id="kt_datatable">
                                    ...
                                    @if(count($services)>0)
                                        ...
                                        @foreach($services as $service)
                                            <tr>
                                                <td>{{$service->id}}</td>
                                                <td><img src="{{asset_public('storage/images/'.$service->image()->pluck('image')[0])}}" style="width: 70px ; height: 60px;"></td>
                                                <td>{{$service->category()->pluck($title)[0]}}</td>
                                                <td>{{$service->$title}}</td>
