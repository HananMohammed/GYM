        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">@lang('services.service-categories')</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.cards.index')}}" class="text-muted">@lang('services.service-categories')</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom gutter-b" style="width: 100%;">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">@lang('services.service-categories')</h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('admin.services-category.create') }}" class="btn btn-primary font-weight-bolder d-flex">
                    <span class="svg-icon svg-icon-md">
                        ...
                        <!--end::Svg Icon-->
                    </span>@lang('services.new-category')</a>
                        <!--end::Button-->
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <table class="table table-bordered table-checkable " id="kt_datatable">
                                    ...
                                    @if(count($categories)>0)
                                        ...
                                        @foreach($categories as $category)
                                            <tr>
                                                <td>{{$category->id}}</td>
                                                <td>{{$category->icon()->pluck('name')[0]}}</td>
...
<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
    ...
    <label class="checkbox checkbox-single">
        ...
        <label class="checkbox checkbox-single">
            ...
            <a href="${currentLocation}/services-category/${data}"class="btn btn-sm btn-clean btn-icon" title="Delete" onclick="event.preventDefault();
